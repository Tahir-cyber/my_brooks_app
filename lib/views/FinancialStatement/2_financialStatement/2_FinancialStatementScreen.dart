...
class FinancialStatementScreen_2 extends StatefulWidget {
  @override
  State<FinancialStatementScreen_2> createState() =>
      _FinancialStatementScreen_2State();
}

class _FinancialStatementScreen_2State
    extends State<FinancialStatementScreen_2> {
  ...
  Widget build(BuildContext context) {
    return Consumer<FinancialStatementViewModel2>(
                          ...
                          ontap: () async {
                            await model.uploadToFirebase(
                                ...
                                noOfYearWithPreviousEmployer:
                                    noOfYearsWithPreviousEmployeerController
                                        .text,
                                ...
                                nameAndPhoneOfYourbroker:
                                    nameAndPhoneNumberOfYourBrokerController
                                        .text,
